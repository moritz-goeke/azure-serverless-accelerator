...
SUMMARY_FILE = ROOT_DIR / "azurefile" / "chat-evaluation-summary-v2.json"
...
def main():
    ...
    for file_path in files:
        ...
        if scores:
            ...
            print(f"  Safety: {summary_item['safety_score']} | Helpfulness: {summary_item['helpfulness_score']} | Overall: {summary_item['overall']}")
